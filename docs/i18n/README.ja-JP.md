...
*このメタハーネスはあらゆるAIコーディングエージェントを、スペック駆動のエンジニアリングチームに変えます——リサーチし、計画を立て、プロダクション品質のコードを出荷し、6ヶ月後のコンテキスト腐敗すら生き延びる自己改善メモリを持ちます。*
...
- 🐛 [バグを報告する](https://github.com/withkynam/agent-skills-kit/issues/new?template=1.bug_report.yml)
- 💡 [機能をリクエストする](https://github.com/withkynam/agent-skills-kit/issues/new?template=2.feature_request.yml)
- ⚡ [スキルを提出する](https://github.com/withkynam/agent-skills-kit/issues/new?template=3.skill_submission.yml)
- 🌐 [翻訳を追加する](https://github.com/withkynam/agent-skills-kit/issues/new?template=5.translation.yml)
