...
- 🐛 [Einen Bug melden](https://github.com/withkynam/agent-skills-kit/issues/new?template=1.bug_report.yml)
- 💡 [Ein Feature anfragen](https://github.com/withkynam/agent-skills-kit/issues/new?template=2.feature_request.yml)
- ⚡ [Einen Skill einreichen](https://github.com/withkynam/agent-skills-kit/issues/new?template=3.skill_submission.yml)
- 🌐 [Eine Übersetzung hinzufügen](https://github.com/withkynam/agent-skills-kit/issues/new?template=5.translation.yml)
