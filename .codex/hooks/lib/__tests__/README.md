...
Comprehensive tests for the Codex hook/statusline compatibility layer and supporting libraries.
...
- `ag-config-utils.test.cjs` - Existing config utility coverage
...
```bash
node .codex/hooks/lib/__tests__/usage-limits-cache.test.cjs
node .codex/hooks/lib/__tests__/statusline.test.cjs
node .codex/hooks/lib/__tests__/statusline-integration.test.cjs
node .codex/hooks/lib/__tests__/statusline-scenarios.test.cjs
```
...
- `/.codex/hooks/lib/colors.cjs`
- `/.codex/hooks/lib/transcript-parser.cjs`
- `/.codex/hooks/lib/config-counter.cjs`
