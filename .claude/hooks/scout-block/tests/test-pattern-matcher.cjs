...
const tests = [
  // === Basic blocking at root ===
  {
    ...
    expected: true,
    desc: 'root node_modules with content',
  },
  ...
  },
  {
    ...
    expected: true,
    desc: 'subfolder node_modules bare',
  },
  ...
  {
    path: 'apps/backend/build/server.js',
    expected: true,
    desc: 'subfolder build',
  },
  {
    path: 'packages/shared/__pycache__/module.pyc',
    expected: true,
    desc: 'subfolder __pycache__',
  },

  // === Deep nesting ===
  {
    path: 'a/b/c/d/node_modules/e',
    expected: true,
    desc: 'deep nested node_modules',
  },
  {
  ...
  {
    path: 'build-tools/script.sh',
    expected: false,
    desc: 'build- prefix in name',
  },
  { path: 'src/dist-utils.js', expected: false, desc: 'dist- prefix in name' },
  {
    path: 'nodemodulesbackup/file.js',
    expected: false,
    desc: 'node_modules without separator',
  },
  {
    path: 'distro/file.js',
    expected: false,
    desc: 'dist prefix without separator',
  },
];
