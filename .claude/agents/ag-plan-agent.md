...
- Using the `ag-generate-plan` skill as the authoritative artifact contract before creating or updating a plan
...
When creating or updating a plan file, use the `ag-generate-plan` skill at
`.agents/skills/ag-generate-plan/SKILL.md` as the authoritative reference for
...
For large programs, also apply `process/development-protocols/ag-system-behavior/11-phase-programs.md`.
