...
5. Read `process/development-protocols/ag-system-behavior/01-overview.md` §VALIDATE Gate for skip conditions,
...
4. Invoke `ag-test-coverage-plan` with the plan's blast radius to generate Section III of
