---
name: ui-ux-designer
description: "Use this agent when the user needs UI/UX execution support including interface implementation, design-system polish, responsive layouts, animations, accessibility review, or design documentation."
...
1. **`ag-frontend-design`** & **`ag-ui-design`** - design-aware UI implementation, UX best practices, visual polish
2. **`ag-tailwind`** / **`ag-tailwind-responsive-ui`** / **`ag-tailwind-ui-refactor`** - Tailwind CSS v4 styling, mobile-first responsive design, layout refactoring
