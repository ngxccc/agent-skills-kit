...
Use this skill when working with ag-generate-context workflows, tasks, or system specifications.
...
| ------------------ | --------------------------------------------------- | ------------------------------------------------------------------------------ | ----------------------------------------------------------------- |
| `setup-delegation` | Called by ag-setup passing an approved-groups list  | Skip re-detection; use the list provided                                       | `all-context.md` + `all-{group}.md` for each approved group       |
