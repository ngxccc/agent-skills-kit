...
<div class="rounded border p-2">
  ...
  <p class="text-sm text-gray-600">
    A new marketing campaign for Q2 launch targeting enterprise customers.
  </p>
  <button class="mt-1 rounded bg-blue-600 px-3 py-1 text-sm text-white">
    View Details
  </button>
</div>
```
...
<div class="rounded border p-6">
  ...
  <button class="mt-5 rounded bg-blue-600 px-4 py-2 text-sm text-white">
    View Details
  </button>
</div>
```
