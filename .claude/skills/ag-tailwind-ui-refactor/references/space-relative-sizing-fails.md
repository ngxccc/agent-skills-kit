...
<div class="p-[2vw]">
  ...
  <button
    class="mt-[2vw] rounded bg-blue-600 px-[2vw] py-[1vw] text-[1.2vw] text-white"
  >
    Get Started
  </button>
</div>
...
<div class="p-4 md:p-6 lg:p-8">
  ...
  <button
    class="mt-4 rounded bg-blue-600 px-4 py-2 text-sm text-white md:px-5 md:py-2.5 md:text-base"
  >
    Get Started
  </button>
</div>
