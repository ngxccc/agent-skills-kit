...
6. **Write design doc** — save to `process/features/{feature}/references/YYYY-MM-DD-<topic>-design.md` (or `process/general-plans/references/YYYY-MM-DD-<topic>-design.md` if general) and commit
...
`process/features/storefront/references/visual-companion.md`

## References

- [Visual Companion Guide](references/visual-companion.md)
