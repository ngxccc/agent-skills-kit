...
`ag-review-situation` operates in two modes. Choose based on the trigger signals below.
...
`ag-review-situation` is advisory.
...
```bash
node .claude/skills/ag-review-situation/scripts/review-situation-scan.cjs --json
```

Useful flags:

```bash
node .claude/skills/ag-review-situation/scripts/review-situation-scan.cjs
node .claude/skills/ag-review-situation/scripts/review-situation-scan.cjs --json --max-branches 8 --plan-limit 6
node .claude/skills/ag-review-situation/scripts/review-situation-scan.cjs --selected-plan process/general-plans/active/example_27-05-26/example_PLAN_27-05-26.md
node .claude/skills/ag-review-situation/scripts/review-situation-scan.cjs --since "14 days ago"
node .claude/skills/ag-review-situation/scripts/review-situation-scan.cjs --fetch
```
...
1. Run standard ag-review-situation check (branch, worktree, active plans list)
