# ag-publish Reference

Detailed reference for the ag-publish skill.

## .ag-publish-config

Create this file in the project root to tell ag-publish where the kit repo checkout lives:

```json
{
  "kitRepoPath": "/Users/you/agent-skills-kit-pro-max-kit"
}
```

- The path must point to a git checkout of `github.com/withkynam/agent-skills-kit-pro-max-kit.git`
...
standing `validate-kit-portability.mjs` validator (run by `ag-audit-vc`) mirrors
...
FILES:
  ...
  [new]       .claude/skills/ag-new-skill/references/new-skill.md
...
Published to: github.com/withkynam/agent-skills-kit-pro-max-kit.git
Tag: v2.2.0
Commit: abc1234
