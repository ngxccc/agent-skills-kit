  ...
  return (
    <>
      ...
      <Suspense fallback={<GreetingSkeleton />}>
        <Greeting />{" "}
        {/* reading cookies keeps this dynamic and inside the boundary */}
      </Suspense>
    </>
  );
}
