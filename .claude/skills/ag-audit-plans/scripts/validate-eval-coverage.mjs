...
// Checks that every ag-system component (skills, agents, canonical phases) has at least one
...
//   --component tag Check only the named component tag (e.g. "agent:ag-plan-agent").
//
// Env vars:
