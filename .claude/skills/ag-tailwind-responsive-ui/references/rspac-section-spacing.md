  ...
  <section class="bg-white py-20">
    <div class="mx-auto max-w-3xl px-4 text-center">
      ...
      <p class="mt-4 text-xl text-gray-500">
        Deploy with confidence using automated testing and one-click rollbacks.
      </p>
      <a
        href="/signup"
        class="mt-8 inline-block rounded-lg bg-blue-600 px-6 py-3 font-semibold text-white shadow-sm hover:bg-blue-700"
        >Start Free Trial</a
      >
    </div>
  </section>
    ...
    <div class="mx-auto max-w-5xl px-4">
      ...
      <div class="mt-12 grid grid-cols-3 gap-8">
        ...
        <div class="text-center">
          ...
          <p class="mt-2 text-sm text-gray-500">
            Set up build, test, and deploy stages in minutes.
          </p>
        </div>
        <div class="text-center">
          <span
          ...
          <p class="mt-2 text-sm text-gray-500">
            Push to main and watch your app go live.
          </p>
        </div>
      </div>
    </div>
...
<main>
  <section class="bg-white py-10 md:py-16 lg:py-20">
    <div class="mx-auto max-w-3xl px-4 text-center">
      ...
      <p class="mt-3 text-lg text-gray-500 md:mt-4 md:text-xl">
        Deploy with confidence using automated testing and one-click rollbacks.
      </p>
      <a
        href="/signup"
        class="mt-6 inline-block rounded-lg bg-blue-600 px-6 py-3 font-semibold text-white shadow-sm hover:bg-blue-700 md:mt-8"
        >Start Free Trial</a
      >
    </div>
  </section>
    ...
    <div class="mx-auto max-w-5xl px-4">
      ...
      <div class="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-3 md:mt-12 md:gap-8">
        <div class="text-center">
          ...
          <p class="mt-1 text-sm text-gray-500 md:mt-2">
            Link your GitHub, GitLab, or Bitbucket repository.
          </p>
        </div>
        <div class="text-center">
  ...
  <section class="bg-white py-10 md:py-16 lg:py-20">
    <div class="mx-auto max-w-3xl px-4 text-center">
      ...
      <p class="mt-3 text-lg text-gray-500 md:mt-4">
        No credit card required. Free for open-source projects.
      </p>
    </div>
  </section>
