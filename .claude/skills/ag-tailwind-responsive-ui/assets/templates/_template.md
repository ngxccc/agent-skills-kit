...
```html
{Bad code example - production-realistic Tailwind HTML} {<!-- Comments explaining the problem -->}
```
...
{Optional: Alternative approach, when NOT to use, benefits list, reference links}
