...
5. Run the seed/scaffold consistency validator:
   ```bash
   node .claude/skills/ag-audit-vc/scripts/validate-seeds.mjs
   ```
...
7. Run the skill invocation wiring validator:
   ```bash
   node .claude/skills/ag-audit-vc/scripts/validate-skill-invocation-wiring.mjs
   ```
8. Run the agent frontmatter validator:
   ```bash
   node .claude/skills/ag-audit-vc/scripts/validate-agent-frontmatter.mjs
   ```
