...
5. **Creating Workflow Documentation**:
   - When creating or editing workflow docs in `second-brain/Docs/<Topic>/`, follow the SSOT Workflow Documentation Standard at `process/development-protocols/references/workflow-documentation-standard.md` (via `ag-docs` skill design mode).
