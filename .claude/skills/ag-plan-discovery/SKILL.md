...
```bash
node .claude/skills/ag-plan-discovery/scripts/discover-plans.mjs [--feature <name>] [--json]
```
...
Route by `description` field for relevance matching (same approach as ag-context-discovery).
