...
3. Activate `ag:scout` skill to explore the code base and return detailed summary reports to the main agent
...
Run `node .claude/skills/ag-audit-context/scripts/validate-context-discovery.mjs` and report
