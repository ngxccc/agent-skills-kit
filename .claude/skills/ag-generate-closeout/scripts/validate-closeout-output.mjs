#!/usr/bin/env node
// Validates a ag-generate-closeout OUTPUT artifact (markdown).
...
if (!target) {
  ...
  // 1. All 8 closeout items present (label keywords, per ag-generate-closeout/SKILL.md Packet Schema).
  const items = [
