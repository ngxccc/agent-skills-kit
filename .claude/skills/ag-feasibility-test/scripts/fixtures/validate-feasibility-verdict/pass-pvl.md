...
```bash
node .claude/skills/ag-feasibility-test/scripts/validate-feasibility-verdict.mjs \
  .claude/skills/ag-feasibility-test/scripts/fixtures/validate-feasibility-verdict/pass-pvl.md
```
