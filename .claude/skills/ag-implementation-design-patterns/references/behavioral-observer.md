...
- The publisher _must not know_ what reacts to its changes — loose coupling is required
...
- The publisher needs to _coordinate_ (not just notify) — reach for **Mediator** instead
