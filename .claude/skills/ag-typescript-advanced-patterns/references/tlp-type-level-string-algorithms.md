...
- `.curated/typescript`'s `advanced-template-literal-types` introduces template literals at the surface level. This rule covers the _recursive composition_ layer — using template literals as control flow, not just as string interpolation.
