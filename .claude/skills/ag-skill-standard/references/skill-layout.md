...
*   **description**: MUST explain both *what* the skill is and *when* the agent should load it. It must be between 24 and 1024 characters and contain at least one of the trigger words: `use`, `when`, `for`.
