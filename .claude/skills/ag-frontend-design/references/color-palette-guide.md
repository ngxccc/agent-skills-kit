...
:root {
  ...
  --background: oklch(0.982 0.005 240.0);    /* Cool Slate Canvas #F8FAFC */
  --foreground: oklch(0.180 0.010 240.0);    /* Deep Graphite Text #0F172A */
  --card: oklch(0.995 0 0);                 /* Pure White Surface */
  --card-foreground: oklch(0.180 0.010 240.0);
  --popover: oklch(0.995 0 0);
  --popover-foreground: oklch(0.180 0.010 240.0);
  --primary: oklch(0.520 0.210 255.0);       /* Electric Cobalt Accent #0284C7 */
  --primary-foreground: oklch(0.985 0 0);
  --secondary: oklch(0.950 0.008 240.0);   /* Machined Slate Tint #F1F5F9 */
  --secondary-foreground: oklch(0.220 0.010 240.0);
  --muted: oklch(0.950 0.008 240.0);
  --muted-foreground: oklch(0.520 0.010 240.0);/* Slate Label */
  --accent: oklch(0.950 0.008 240.0);
  --accent-foreground: oklch(0.180 0.010 240.0);
  --destructive: oklch(0.580 0.200 25.0);   /* Signal Crimson */
  --border: oklch(0.900 0.008 240.0);       /* 1px Cool Slate Border */
  --input: oklch(0.900 0.008 240.0);
  --ring: oklch(0.520 0.210 255.0);         /* Cobalt Focus Ring */
  --radius: 0.625rem;
}

.dark {
  /* Dark Mode - Deep Graphite & Electric Cobalt */
  --background: oklch(0.145 0.010 240.0);   /* Deep Slate Canvas */
  --foreground: oklch(0.982 0.005 240.0);   /* Cool Slate Text */
  --card: oklch(0.180 0.010 240.0);        /* Graphite Surface Card */
  --card-foreground: oklch(0.982 0.005 240.0);
  --popover: oklch(0.180 0.010 240.0);
  --popover-foreground: oklch(0.982 0.005 240.0);
  --primary: oklch(0.580 0.210 255.0);       /* Vibrant Electric Cobalt */
  --primary-foreground: oklch(0.985 0 0);
  --secondary: oklch(0.240 0.010 240.0);
  --secondary-foreground: oklch(0.982 0.005 240.0);
  --muted: oklch(0.240 0.010 240.0);
  --muted-foreground: oklch(0.680 0.010 240.0);
  --accent: oklch(0.240 0.010 240.0);
  --accent-foreground: oklch(0.982 0.005 240.0);
  --destructive: oklch(0.600 0.185 25.0);
  --border: oklch(1 0 0 / 12%);
  --input: oklch(1 0 0 / 15%);
  --ring: oklch(0.580 0.210 255.0);
}
```
