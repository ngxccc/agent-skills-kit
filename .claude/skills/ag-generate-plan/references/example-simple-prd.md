...
> **IMPORTANT:** Step 2 is never skippable. A placeholder Validate Contract is a blocker — do not proceed to step 3 until a ag-validate-agent gate verdict is present.

## Validate Contract

_ag-validate-agent writes this section before EXECUTE. Do not start EXECUTE with this placeholder in place._
