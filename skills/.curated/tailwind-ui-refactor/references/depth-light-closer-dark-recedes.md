...
<div class="flex">
  <aside class="w-56 bg-gray-900 p-4">
    <nav class="space-y-1">
      <a
        class="block rounded-lg bg-gray-800 px-3 py-2 text-sm font-medium text-white"
        >Dashboard</a
      >
      <a
        class="block rounded-lg px-3 py-2 text-sm text-gray-400 hover:bg-gray-800 hover:text-white"
        >Projects</a
      >
    </nav>
  </aside>
