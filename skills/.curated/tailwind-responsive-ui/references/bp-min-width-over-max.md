...
<div
  class="flex gap-8 max-[1024px]:gap-6 max-[768px]:gap-4 max-[768px]:flex-col"
>
  ...
  <main
    class="flex-1 max-[768px]:border-t max-[768px]:border-l-0 border-l border-gray-200 max-[768px]:pl-0 max-[768px]:pt-4 pl-8"
  >
...
<div class="flex flex-col gap-4 md:flex-row md:gap-8">
  ...
  <main
    class="flex-1 border-t border-gray-200 pt-4 md:border-l md:border-t-0 md:pl-8 md:pt-0"
  >
