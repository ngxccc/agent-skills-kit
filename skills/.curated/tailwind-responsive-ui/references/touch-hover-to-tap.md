...
<div class="group relative rounded-lg border bg-white p-4 shadow-sm">
  ...
  <div
    class="absolute inset-0 flex items-center justify-center gap-2 rounded-lg bg-black/40 opacity-0 transition-opacity group-hover:opacity-100"
  >
    <button class="rounded-full bg-white px-4 py-2 text-sm font-medium">
      Quick View
    </button>
    <button
      class="rounded-full bg-blue-600 px-4 py-2 text-sm font-medium text-white"
    >
      Add to Cart
    </button>
  </div>
...
<div class="group relative rounded-lg border bg-white p-4 shadow-sm">
  ...
  <div
    class="mt-3 flex gap-2 opacity-100 transition-opacity md:absolute md:inset-0 md:mt-0 md:items-center md:justify-center md:rounded-lg md:bg-black/40 md:opacity-0 md:group-hover:opacity-100"
  >
    <button
      class="rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-medium md:border-0"
    >
      Quick View
    </button>
    <button
