...
<article class="mx-auto max-w-3xl px-4 py-8">
  <h1
    class="text-3xl font-bold leading-relaxed text-gray-900 md:text-5xl md:leading-relaxed"
  >
...
<article class="mx-auto max-w-3xl px-4 py-8">
  <h1
    class="text-3xl font-bold leading-tight text-gray-900 md:text-5xl md:leading-[1.15]"
  >
    Building Responsive Interfaces That Scale Across Every Device
  </h1>
