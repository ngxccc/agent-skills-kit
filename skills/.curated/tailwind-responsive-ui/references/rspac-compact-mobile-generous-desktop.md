  ...
  <section class="py-24">
    <div class="mx-auto max-w-4xl px-4">
      ...
      <p class="mt-6 text-lg text-gray-600">
        We deliver results that speak for themselves with a team of dedicated
        experts.
      </p>
      <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-3">
        <div class="text-center">
          <div
            class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-blue-100 text-blue-600"
          >
            <svg
              class="h-8 w-8"
              fill="none"
        ...
        <div class="text-center">
          <div
            class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-purple-100 text-purple-600"
          >
            <svg
              class="h-8 w-8"
              fill="none"
    ...
    <div class="mx-auto max-w-4xl px-4">
      ...
      <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-3 md:mt-12 md:gap-8">
        <div class="text-center">
          ...
          <h3 class="mt-3 font-semibold text-gray-900 md:mt-4">
            Lightning Fast
          </h3>
