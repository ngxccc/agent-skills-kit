...
## Replace _-opacity-_ Utilities with Opacity Modifiers
...
<div class="bg-blue-500 bg-opacity-50">
  <p class="text-red-600 text-opacity-75"></p>
  <div class="border border-gray-300 border-opacity-25">
    <div class="divide-y divide-slate-200 divide-opacity-50">
      <div class="ring ring-indigo-500 ring-opacity-30">
        <input
          class="placeholder-gray-400 placeholder-opacity-60"
          placeholder="Search..."
        />
      </div>
    </div>
