...
## Replace bg-gradient-_ with bg-linear-_
...
```html
<div class="bg-gradient-to-r from-blue-500 to-purple-600">Gradient banner</div>
```

**Correct (what's right):**

```html
<div class="bg-linear-to-r from-blue-500 to-purple-600">Gradient banner</div>
```
