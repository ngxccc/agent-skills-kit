...
<button
  class="opacity-50 cursor-not-allowed enabled:opacity-100 enabled:cursor-pointer"
>
  Submit
</button>
```
...
<button
  class="not-disabled:opacity-100 not-disabled:cursor-pointer opacity-50 cursor-not-allowed"
>
  Submit
</button>
```
