...
function mapOptional<A, B>(fa: A | null, f: (a: A) => B): B | null {
...
const OptionalFunctor: Functor<"Optional"> = {
...
function double<URI extends URIS>(
  F: Functor<URI>,
  fa: Kind<URI, number>,
): Kind<URI, number> {
