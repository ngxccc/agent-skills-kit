...
echo ""
echo "  agent-skills-kit installer"
echo "  ─────────────────────────────────"
echo ""
...
VERSION=$(node -e "console.log(JSON.parse(require('fs').readFileSync('$TMPDIR/ag-manifest.json','utf8')).version)" 2>/dev/null || echo "unknown")
...
echo "  Next:"
echo "    1. Run: claude"
echo '    2. Say: "Run ag-setup"'
echo ""
echo "  ag-setup will auto-detect your project, scaffold the process/"
